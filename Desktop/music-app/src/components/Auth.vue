  ...
  <div>
    <div class="fixed z-10 inset-0 overflow-y-auto"
      :class="{hidden: !authModalShow}" id="modal">
        <div class="flex items-end justify-center min-h-screen pt-4
            ...
            <div class="py-4 text-left px-6">
              ...
              <ul class="flex flex-wrap mb-4">
                ...
                <li class="flex-auto text-center">
                  ...
                  @click.prevent="tab ='register'" @submit="register"
                    href="#">Register</a>
                </li>
              </ul>
                ...
                <div class="mb-3">
                  ...
                  <vee-field name="password" :bails="false" v-slot="{ field, errors }">
                     <input type="password" class="block w-full py-1.5 px-3 text-gray-800 border
                      ...
                      focus:border-black rounded" placeholder="Password" v-bind="field" />
  ...
  data() {
    return {
      ...
      schema: {
        ...
        country: 'required|country_excluded:Pakistan',
        tos: 'tos',
      },
      userData: {
        country: 'USA',
