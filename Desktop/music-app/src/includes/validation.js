    ...
    configure({
      generateMessage: (ctx) => {
        const messages = {
          ...
          alpha_spaces: `The field ${ctx.field} may contain alphabetical characters and spaces.`,
        ...
        const message = messages[ctx.rule.name] ? messages[ctx.rule.name] : `The field ${ctx.field} is not available.`;
        return message;
      },
      validateOnBlur: true,
